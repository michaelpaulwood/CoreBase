        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <Step
              ...
              description="git clone https://github.com/michaelpaulwood/CoreBase.git - Get the complete boilerplate with all features ready to go."
              icon="📥"
            />
            <Step
              step="02"
        ...
        <Container>
          <div className="text-center mb-20 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know about CoreBase
            </p>
          </div>

          <div className="space-y-6 max-w-4xl mx-auto">
            <FAQItem
              question="What makes CoreBase different from other boilerplates?"
              answer="CoreBase is production-ready out of the box with Firebase integration, comprehensive error handling, and modern UI components. No more spending weeks on setup - start building your features immediately."
            />
            <FAQItem
              question="Do I need to know Firebase to use CoreBase?"
              answer="Not at all! CoreBase comes with pre-configured Firebase setup, helper functions, and clear documentation. Just add your Firebase config and start using authentication and database features right away."
            />
            <FAQItem
            ...
            />
            <FAQItem
              question="Is CoreBase suitable for production applications?"
              answer="Yes! CoreBase includes error boundaries, loading states, TypeScript throughout, and follows Next.js best practices. Many developers use it to ship production applications quickly and reliably."
            />
            <FAQItem
              question="What support is available?"
              answer="CoreBase comes with comprehensive documentation, code comments, and examples. The codebase is designed to be self-documenting and easy to understand for developers of all levels."
            />
            <FAQItem
              question="Can I deploy CoreBase to platforms other than Vercel?"
              answer="Yes! CoreBase works on any platform that supports Next.js - including Netlify, Railway, DigitalOcean App Platform, AWS Amplify, and more. Deployment instructions are included."
            />
          </div>
        </Container>
      </Section>
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              ...
              Join hundreds of developers building faster with CoreBase.
            </p>
